...
def attrs(
    ...
    :param bool match_args:
        ...
        Pattern Matching). It is a tuple of all positional-only ``__init__.py``
...
if PY2:
    ...
    raise TypeError(
        '__init__.py() missing required keyword-only argument: %s' % _key_error
    )
if _kw_only:
    raise TypeError(
        '__init__.py() got an unexpected keyword argument %r'
        % next(iter(_kw_only))
    )
""".split(
            "\n"
