...
def add_additional_orm_attributes(
    ...
    """Apply __init__.py, __table__ and other attributes to the mapped class."""
    ...
    if "__init__.py" not in info.names and not is_base:
        ...
        add_method_to_class(api, cls, "__init__.py", arguments, NoneTyp())
