...
class Mapper(
    ...
    def _configure_class_instrumentation(self):
        ...
        `__init__.py` method on the mapped class to include optional
        ...
        # the __init__.py method.  documented behavior is that this must
        ...
        manager = instrumentation.register_class(
            ...
            # finalize flag means instrument the __init__.py method
        ...
        for key, method in util.iterate_attributes(self.class_):
            if key == "__init__.py" and hasattr(method, "_sa_original_init"):
...
def reconstructor(fn):
    ...
    Designates a single method as the "reconstructor", an ``__init__.py``-like
