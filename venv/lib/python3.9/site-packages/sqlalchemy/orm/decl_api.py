...
def declarative_base(
    ...
    :param constructor:
      Specify the implementation for the ``__init__.py`` function on a mapped
      class that has no ``__init__.py`` of its own.  Defaults to an
      implementation that assigns \**kwargs for declared
      fields and relationships to an instance.  If ``None`` is supplied,
      no __init__.py will be provided and construction will fall back to
      cls.__init__.py by way of the normal Python semantics.
    ...
    def generate_base(
        ...
        non-dynamic example below::
            ...
            class Base(metaclass=DeclarativeMeta):
                ...
                __init__.py = mapper_registry.constructor
        ...
        if self.constructor:
            class_dict["__init__.py"] = self.constructor
